...
```{r passModel, echo=FALSE, warning=FALSE}
...
```{r preBalance, echo = FALSE, warning=FALSE}
...
```{r selMod, echo=FALSE, warning=FALSE}
...
```{r outcomeMod, echo=FALSE, warning=FALSE}
...
```{r postBal, echo=FALSE, warning=FALSE}
...
```{r preBal, echo = FALSE,warning=FALSE}
# balance analysis before estimating propensity scores
...
```{r selModel, echo = FALSE,warning=FALSE}
...
```
 ...
 ```{r outcomeModel, echo = FALSE,warning=FALSE}
...
```{r balance, echo = FALSE,warning=FALSE }
